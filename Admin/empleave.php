...
$sql = "Select users.id, users.firstName, users.lastName, employee_leave.start, employee_leave.end, employee_leave.reason, employee_leave.status, employee_leave.token From users, employee_leave Where users.id = employee_leave.id order by employee_leave.token";
